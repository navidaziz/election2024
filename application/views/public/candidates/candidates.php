...
<th><?php echo $this->lang->line('image'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            ?>
                                ...
                                <a class="llink llink-view" href="<?php echo site_url("candidates/view_candidate/".$candidate->candidate_id."/".$this->uri->segment(4)); ?>"> View </a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
