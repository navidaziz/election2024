...
<div id="sidebar" <?php if ($this->router->fetch_class() == 'election_dashboard' or $this->router->fetch_class() == 'polling_stationss') { ?> class="sidebar mini-menu" <?php } else { ?>class="sidebar" <?php } ?>>
...
AND  `groups`.`group_id` = " . $this->session->userdata('group_id');
    ...
    <div class="sidebar-menu nav-collapse">
        ...
        <h4 style="text-align:center; color:red">Beta.</h4>
